...
func NewKoinosCommandSet() *CommandSet {
	...
	cs.AddCommand(NewCommandDeclaration("set_system_call", "Set a system call to a new contract and entry point", false, NewSetSystemCallCommand, *NewCommandArg("system-call", UIntArg), *NewCommandArg("contract-id", AddressArg), *NewCommandArg("entry-point", HexArg)))
